...
| 1351 | [Count Negative Numbers in a Sorted Matrix](https://leetcode.com/problems/count-negative-numbers-in-a-sorted-matrix/)  | Increase counter with every negative number entered       | [C++]()            | O(m*n) | O(1)  | Easy       | Array brute force search |    [📺](https://www.youtube.com/watch?v=IUkUmhXZ77c)    |
